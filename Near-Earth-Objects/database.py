...
class NEODatabase:
    ...
    def __init__(self, neos, approaches):
        ...
        for approach in self._approaches:
            ...
            if approach._designation in self.designation_dict.keys():
                near_earth_obj = self.designation_dict[approach._designation]
                near_earth_obj.approaches.append(approach)
                approach.neo = near_earth_obj
    ...
    def get_neo_by_designation(self, designation):
        ...
        or `None`.
        """
        return self.designation_dict.get(designation, None)
    ...
    def get_neo_by_name(self, name):
        ...
        with the empty string nor with the `None` singleton.
