...
class AttributeFilter:
    ...
    def __repr__(self):
        ...
        It returns a computer-readable string representation of this object.
        """
...
class DateFilter(AttributeFilter):
    ...
    @classmethod
    def get(cls, approach):
        """Return approach.time converted to datetime.datetime object.
...
class DistanceFilter(AttributeFilter):
    ...
    @classmethod
    def get(cls, approach):
        """Return float(distance) of the CloseApproach object.
...
class VelocityFilter(AttributeFilter):
    """Subclass of AttributeFilter to filter approach objects."""

    @classmethod
    def get(cls, approach):
        """Class returns float(velocity) of the CloseApproach object.
...
class DiameterFilter(AttributeFilter):
    ...
    @classmethod
    def get(cls, approach):
        """Class returns the diameter of the type float.

        The diameter of the neo assigned to the CloseApproach object.
...
class HazardousFilter(AttributeFilter):
    ...
    This class filters CloseApproach objects by if it's
    hazardous.
    """

    @classmethod
    def get(cls, approach):
        """Return the hazardous attribute of type boolean.

        Hazardous attribute of the neo assigned to the CloseApproach
        object.
